<div align="center">
  <img src="./etc/banner.png" alt="preview" width="32-px" height="80px" />
  <br />
...
- **신뢰성 있는 리뷰**: 사용자들이 직접 작성한 리뷰와 별점을 통해 신뢰도 높은 정보를 제공합니다.
- **개인화된 경험**: '나만의 맛집 리스트'를 만들 수 있는 즐겨찾기 기능을 지원합니다.
...
│   │   └── webapp/
│   │       ├── resources/  # CSS, JavaScript, 이미지 등 정적 파일
│   │       └── WEB-INF/
│   │           ├── jsp/      # JSP 뷰 파일
│   │           └── spring/   # Spring 설정 파일
│   └── test/
